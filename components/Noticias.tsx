...
// Componente raíz: muestra el gate de contraseña hasta que se autentique,
// luego renderiza el panel real (AdminPanel).
export default function AdminPage() {
  ...
  useEffect(() => {
    // Recuerda la sesión mientras la pestaña siga abierta
  ...
  async function handleLogin(e: FormEvent) {
    ...
    try {
      ...
      setLoginError('No se pudo verificar la contraseña. Intenta de nuevo.')
    } finally {
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 bg-[#7A1F2B] text-white text-sm px-4 py-2 rounded-md hover:bg-[#5B0F18] transition"
              >
                <svg

...
export const MESAS_DEBATE: MesaDebate[] = [
  {
    id: 'mesa-1',
    numero: 1,
    titulo: 'Gobernanza y Planificación del Ecosistema de Innovación',
  ...
  },
  {
    id: 'mesa-2',
    numero: 2,
    titulo: 'Talento, Emprendimiento y Programas Municipales',
  ...
  },
  {
    id: 'mesa-3',
    numero: 3,
    titulo: 'Instrumentos Estratégicos para la Innovación',
  ...
  },
  {
    id: 'mesa-4',
    numero: 4,
    titulo: 'Implementación, Sostenibilidad y Proyección del Ecosistema',
